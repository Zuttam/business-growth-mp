...
1. **Check for existing content**: Look for past engagement logs in `.business_growth/marketing/social/x/` and other platform directories (`.business_growth/marketing/social/*/`) — read any previous comments/posts the user has approved and posted
...
## Writing Style & Voice
- **Tone**: <e.g., witty expert, helpful peer, data-driven analyst>
