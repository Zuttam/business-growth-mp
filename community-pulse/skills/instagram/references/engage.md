...
2. Posts should be discovered and saved to `.business_growth/marketing/social/instagram/{YYYY-MM}/{YYYY-MM-DD}.md`
3. User must be logged into Instagram in the browser (use login skill or log in manually)
